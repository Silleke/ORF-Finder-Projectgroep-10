 ...
 * @author Tim Kuijpers
 * 30-3-2017
 * In deze class wordt connectie gemaakt met de SQL database. De database wordt gevuld 
 * en gegevens worden uit de database opgehaald.
 * 
 * Let op!
 * Zorg dat MySQL JDBC driver is geïnstalleerd in dit project.
 */
